...
This file is the quick-reference operating contract for tonic-prost-kotlin. The longer
...
tonic-prost-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tonic-prost`](https://crates.io/crates/tonic-prost). Upstream Rust is the behavioral oracle while the
