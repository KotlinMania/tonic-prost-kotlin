...
kotlin {
    ...
    val xcf = XCFramework("TonicProst")
    ...
    swiftExport {
        moduleName = "TonicProst"
        flattenPackage = "io.github.kotlinmania.tonicprost"
    }

    android {
        namespace = "io.github.kotlinmania.tonicprost"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tonic-prost-kotlin", version.toString())

    pom {
        name.set("tonic-prost-kotlin")
        description.set("Kotlin Multiplatform port of hyperium/tonic - Prost codec implementation for tonic")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tonic-prost-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tonic-prost-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tonic-prost-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tonic-prost-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTonicProstXCFramework",
    "assembleTonicProstDebugXCFramework",
    "assembleTonicProstReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTonicProstXCFramework",
    "assembleReleaseIosFatFrameworkForTonicProstXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTonicProstXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTonicProstXCFramework",
    "assembleDebugMacosFatFrameworkForTonicProstXCFramework",
    "assembleReleaseMacosFatFrameworkForTonicProstXCFramework",
    "assembleDebugTvosFatFrameworkForTonicProstXCFramework",
    "assembleReleaseTvosFatFrameworkForTonicProstXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTonicProstXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTonicProstXCFramework",
    "assembleDebugWatchosFatFrameworkForTonicProstXCFramework",
    "assembleReleaseWatchosFatFrameworkForTonicProstXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTonicProstXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTonicProstXCFramework",
